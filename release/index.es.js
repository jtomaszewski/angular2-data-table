 ...
 * Licensed under MIT
 */
import { NgModule, ChangeDetectorRef, ElementRef, Renderer, Host, Component, HostBinding, HostListener, QueryList, ContentChildren, EventEmitter, Output, Input, Directive, TemplateRef, Injectable, ChangeDetectionStrategy, ViewChild } from '@angular/core';
...
var StateService = (function () {
    function StateService() {
        ...
        this.onOptionsUpdate = new EventEmitter();
...
var DataTable = (function () {
    ...
    DataTable = __decorate([
        ...
        __param(0, Host()), 
        __metadata('design:paramtypes', [(typeof (_h = typeof StateService !== 'undefined' && StateService) === 'function' && _h) || Object, (typeof (_j = typeof Renderer !== 'undefined' && Renderer) === 'function' && _j) || Object, (typeof (_k = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _k) || Object, (typeof (_l = typeof ChangeDetectorRef !== 'undefined' && ChangeDetectorRef) === 'function' && _l) || Object])
    ], DataTable);
    return DataTable;
